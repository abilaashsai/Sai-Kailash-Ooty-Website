 ...
 * It is required in signOutFunction cases like linking flows, where the user can become
 * signed in and the widget still has to perform signOutFunction operations (linking)
...
firebaseui.auth.AuthUI.prototype.start = function(element, config) {
  ...
  var onReady = function() {
    var resetWarning = 'UI Widget is already rendered on the page and is pen' +
        'ding signOutFunction user interaction. Only one widget instance can be rendere' +
